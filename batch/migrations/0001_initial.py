    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(choices=batch.models.previous_years, default=batch.models.current_year, verbose_name='year')),
                ...
                ('student', models.ManyToManyField(related_name='batch_students', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Batch',
